...
main = do
  ...
  case opts of
    ...
    Options _ _ _ Nothing -> putStrLn "Please, provide the client's NAME ... "
...
parserInfo = info (helper <*> optionParser)
  ( fullDesc <>
    progDesc " client ready to connect to a server ... " <>
    header "Server client powered by Cloud Haskell ... "     )
...
optionParser = Options
  ...
  ( long     "interface server"      <>
    ...
    value    Nothing     <>
    help
    "The interface server  we want to connect to." )
  where
